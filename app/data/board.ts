...
export const BOARD_ANNOTATIONS: BoardAnnotation[] = [
  {
    ...
    designator: "U7",
    label: "Main MCU",
    detail: "32-bit microcontroller · LQFP-100",
  ...
  },
  {
    ...
    detail: "MS5607-02BA03 pressure sensor",
  ...
  },
  {
    ...
    designator: "IC1",
    label: "Onboard Flash",
    detail: "SPI NOR flash · SOIC-8",
    anchor: [-0.124, -0.0219, -0.374],
  },
  {
    id: "storage",
    designator: "J4",
    label: "Flight Data Storage",
    detail: "microSD · push-pull socket",
  ...
  },
  {
    ...
    detail: "SMA edge connector",
    anchor: [0.061, -0.0213, 0.3104],
  },
  {
    id: "power",
    designator: "J5",
